...
function addFavorites(event){
    ...
    let popularity = element.parentNode.parentNode.querySelector('u').textContent;
...
function ytRequest(event){
    ...
    let release_date = element.parentNode.parentNode.querySelector('u').textContent;
...
function createMovieItem(album,result){
    ...
    if(result.list === false){
        watch_list.src = "./images/add-to-queue-regular-24.png";
...
function onRemoveListJson(json){
    ...
    if(json.op===true){
        button.src="./images/add-to-queue-regular-24.png";
...
function onAddListJson(json){
    ...
    if(json.op === true){
        button.src="./images/add-to-queue-solid-24.png";
        button.addEventListener('click',removeFavorites);
        button.removeEventListener('click',addFavorites);
