...
<main>
    ...
    <?php echo csrf_field(); ?>
        ...
        <?php endif; ?>
        <p>Non hai un account? <a id="reg" href="<?php echo e(url('signup')); ?>">Registrati</a></p>
        <label>&nbsp;<input type='submit' id="submit" value="Accedi"></label>
    </form>
</main>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.login_signup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Top Movies laravel\hw2\resources\views/login.blade.php ENDPATH**/ ?>