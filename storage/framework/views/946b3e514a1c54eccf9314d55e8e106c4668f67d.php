                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    <?php else: ?>
                        ...
                        <?php if(Route::has('signup')): ?>
                            <a href="<?php echo e(route('signup')); ?>" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Register</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\Top Movies laravel\example-app\resources\views/welcome.blade.php ENDPATH**/ ?>